package io.like.utils;

import io.like.config.MongoManager;
import io.like.entity.ColumnEntity;
import io.like.entity.TableEntity;
import io.like.entity.mongo.MongoDefinition;
import io.like.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    private static String replaceStr ="Idea";
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        tableEntity.setTableName(tableEntity.getTableName());

        tableEntity.setClassName(className.replaceAll(replaceStr,""));
